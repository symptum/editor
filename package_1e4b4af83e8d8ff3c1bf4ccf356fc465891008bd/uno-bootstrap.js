                ...
                static async bootstrap() {
                    try {
                        ...
                        if (logProfilerEnabled) {
                            ...
                            moduleConfig.out = (message) => {
                                if (typeof message === "string" && (message.startsWith("log-profiler not called") ||
    ...
    (function (WebAssembly) {
        ...
        (function (Bootstrap) {
            class LogProfilerSupport {
                ...
                async ensureInitializeProfilerMethods() {
                    if (LogProfilerSupport._logProfilerEnabled && !this._flushLogProfile) {
                        const anyContext = this._context;
