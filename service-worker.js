import { config } from "/editor/package_b97ac71e03119b425fd2e0045b8e6aedf45895af/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_b97ac71e03119b425fd2e0045b8e6aedf45895af').then(async function (cache) {
