import { config as unoConfig } from "/editor/package_1e4b4af83e8d8ff3c1bf4ccf356fc465891008bd/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('f5c3507d-36f9-42b0-8e45-f7b85f2726bb').then(async function (cache) {
                ...
                try {
                    ...
                    const response = await fetch(`/editor/_framework/${unoConfig.dotnet_js_filename}`);
                    if (!response.ok) {
                    ...
                    const frameworkUris = [
                        ...
                        filename => `/editor/_framework/${filename}`
                    );
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== 'f5c3507d-36f9-42b0-8e45-f7b85f2726bb';
